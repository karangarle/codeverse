// Static data compiled automatically from database
...
export const staticCourses: Course[] = [
  {
    "_id": "6a454d73804dde39cc65cf13",
    "title": "JavaScript Essentials",
    "slug": "javascript-essentials",
    "description": "Master modern JavaScript (ES6+) from basic syntax and variables up to advanced closures, prototypes, event loops, and DOM handlers.",
    "level": "beginner",
    "duration": 320,
    "order": 1
  },
  {
    "_id": "6a454d73804dde39cc65cf14",
...
export const staticTopics: Topic[] = [
  {
    "_id": "6a454d73804dde39cc65cf01",
    "title": "Introduction & Execution Context",
    "slug": "js-execution-context",
    "shortDescription": "Learn how JavaScript engines parse and execute code using execution contexts and call stacks.",
    "content": "JavaScript executes code inside an **Execution Context**. It contains two phases:\n1. **Memory Creation Phase**: Scans code for variables and functions and allocates memory (variables are set to undefined, functions are stored as code).\n2. **Code Execution Phase**: Runs code line-by-line.\n\n**Call Stack** keeps track of execution context states.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf02",
    "title": "Variables & Scope (var, let, const)",
    "slug": "js-variables-scope",
    "shortDescription": "Understand variables definition, block scope, functional scope, and shadow behavior.",
    "content": "- **var**: Function-scoped, can be redeclared and re-assigned.\n- **let**: Block-scoped, cannot be redeclared but can be re-assigned.\n- **const**: Block-scoped, cannot be redeclared or re-assigned (binds reference).",
  ...
  {
    "_id": "6a454d73804dde39cc65cf03",
    "title": "Data Types & Memory Allocation",
    "slug": "js-datatypes-memory",
    "shortDescription": "Primitive vs reference types and how Stack and Heap allocation works.",
    "content": "- **Stack Memory**: Used for Primitive types. Compares by value.\n- **Heap Memory**: Used for Non-Primitive types (Objects, Arrays). Compares by reference.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf04",
    "title": "Arrays & Array Operations",
    "slug": "js-arrays-methods",
    "shortDescription": "Master built-in array methods including push, pop, shift, unshift, slice, and splice.",
    "content": "- **shift()**: Removes first element.\n- **unshift()**: Adds to beginning.\n- **slice()**: Returns shallow copy of subset array.\n- **splice()**: Modifies array contents by removing or replacing elements.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf05",
    "title": "Functions & Hoisting",
    "slug": "js-functions-hoisting",
    "shortDescription": "Understand function declarations, expressions, arrow functions, and hoisting.",
    "content": "- **Declarations** are fully hoisted. Can be called before definition.\n- **Expressions** are not hoisted (in TDZ).\n- **Arrow Functions** bind context lexically.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf06",
    "title": "High-Order Functions",
    "slug": "js-high-order-functions",
    "shortDescription": "Perform clean data transformations using map, filter, and reduce.",
    "content": "- **map()**: Transforms every item.\n- **filter()**: Selects items matching a predicate.\n- **reduce()**: Accumulates items into a single result value.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf07",
    "title": "DOM Manipulation",
    "slug": "js-dom-manipulation",
    "shortDescription": "Query DOM nodes, change text/HTML, modify styles, and handle click events.",
    "content": "Use selectors like querySelector or getElementById to access DOM nodes, change their values, styles, or attach event listeners.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf08",
    "title": "Asynchronous JS & Event Loop",
    "slug": "js-async-eventloop",
    "shortDescription": "Understand event loop execution order, task queues, promises, and async/await.",
    "content": "JS is single-threaded. It offloads operations like setTimeout to Web APIs, resolving their callbacks in the Callback/Microtask Queue via the Event Loop.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf09",
    "title": "Closures & Lexical Scope",
    "slug": "js-closures",
    "shortDescription": "A closure is a function that retains access to its lexical scope even after parent function has closed.",
    "content": "Whenever a function is declared inside another, the inner function retains references to the outer variables.",
  ...
  {
    "_id": "6a454d73804dde39cc65cf0a",
    "title": "Prototypes & OOP Classes",
    "slug": "js-prototypes-oop",
    "shortDescription": "Deep dive into JavaScript prototype chains, class constructors, getters, setters, and static methods.",
    "content": "Every object in JavaScript has a prototype link pointing to prototype properties, providing class inheritance behavior.",
  ...
  },
  {
    ...
    "codeLanguage": "jsx",
    "visualizeUrl": "",
    "videoUrl": "https://www.youtube.com/watch?v=IdlF1zsUN3M",
    "estimatedMinutes": 30,
    "order": 8,
    "course": {
      "_id": "6a454d73804dde39cc65cf14",
  ...
  },
  {
    ...
    "codeLanguage": "javascript",
    "visualizeUrl": "",
    "videoUrl": "https://www.youtube.com/watch?v=y3_j7C7rO9c&list=PLinedj3B30sDby4Al-i13hQJGQoRQDfPo",
    "estimatedMinutes": 20,
    "order": 1,
    "course": {
      "_id": "6a454d73804dde39cc65cf15",
  ...
  },
  {
    ...
    "codeLanguage": "javascript",
    "visualizeUrl": "",
    "videoUrl": "https://www.youtube.com/watch?v=EAR7Mte8qA4&list=PLgUwDviBIf0oF6QL8m22w1hIDC1vJ_BHz",
    "estimatedMinutes": 40,
    "order": 1,
    "course": {
      "_id": "6a454d73804dde39cc65cf16",
...
export const staticRevisions: Revision[] = [
  {
    "_id": "6a454d73804dde39cc65cf36",
...
export const staticInterviewQuestions: InterviewQuestion[] = [
  ...
  {
    "_id": "6a454d73804dde39cc65cfbb",
    "question": "What is Redis and how do you use it for caching in a MERN stack application to improve performance?",
    "answer": "Redis (Remote Dictionary Server) is an open-source, in-memory key-value data structure store. It is extremely fast (sub-millisecond latency) because it keeps all data in RAM.\n\n**Why use Redis caching?**\nIn a standard MERN application, fetching data (like a product list or user profile) requires querying MongoDB, which reads from the disk or DB memory. Under high traffic, this causes server bottlenecks. By caching query results in Redis, subsequent requests are served instantly from memory without querying MongoDB.\n\n**Caching Strategy (Cache-Aside Pattern):**\n1. Client requests data.\n2. Server checks Redis using a unique key (e.g., `products:all`).\n3. If data is found (**Cache Hit**), return it immediately.\n4. If not found (**Cache Miss**), query MongoDB, store the result in Redis with a Time-To-Live (TTL) expiration, and return the data.\n\n```javascript\nimport { createClient } from 'redis';\nconst redisClient = createClient();\nawait redisClient.connect();\n\napp.get('/api/products', async (req, res) => {\n  const cacheKey = 'products:all';\n  \n  // 1. Try to fetch from Redis cache\n  const cachedData = await redisClient.get(cacheKey);\n  if (cachedData) {\n    return res.json({ source: 'cache', data: JSON.parse(cachedData) });\n  }\n\n  // 2. Cache Miss - Query MongoDB\n  const products = await Product.find();\n\n  // 3. Save result to Redis with TTL (e.g., 1 hour / 3600 seconds)\n  await redisClient.setEx(cacheKey, 3600, JSON.stringify(products));\n\n  res.json({ source: 'database', data: products });\n});\n```",
    "difficulty": "medium",
    "category": "Node.js Deep Dive"
  },
  {
    "_id": "6a454d73804dde39cc65cfbc",
    "question": "What is the difference between the Next.js App Router and Pages Router? Which one is preferred?",
    "answer": "Next.js offers two routing systems: the traditional **Pages Router** and the modern **App Router** (introduced in Next.js 13).\n\n### 1. Pages Router (`/pages` directory)\n- **Routing**: Every file inside `/pages` automatically becomes a route (e.g., `pages/about.js` -> `/about`).\n- **Data Fetching**: Relies on page-level functions like `getServerSideProps` (SSR), `getStaticProps` (SSG), and `getStaticPaths`.\n- **Component Type**: All components are rendered on the client-side by default (traditional React components).\n\n### 2. App Router (`/app` directory - Recommended)\n- **Routing**: Folder-based routing where folders define paths and `page.js` files render the UI (e.g., `app/about/page.js` -> `/about`). Supports advanced layout nesting.\n- **React Server Components (RSC)**: Components are Server Components by default. They run on the server and send pre-rendered HTML to the client, reducing JS bundle sizes. To use client-side logic (state, hooks, event listeners), you add `'use client'` at the top of the file.\n- **Data Fetching**: Simplified using standard asynchronous `fetch()` calls directly inside Server Components without special functions.\n\n| Feature | Pages Router | App Router |\n|---|---|---|\n| **Routing Schema** | File-based (`pages/about.js`) | Folder-based (`app/about/page.js`) |\n| **Default Components** | Client Components | Server Components (RSC) |\n| **Layouts** | Custom layout wrappers | Native nested layouts (`layout.js`) |\n| **Data Fetching** | `getStaticProps`, `getServerSideProps` | Asynchronous `async/await fetch()` |",
    "difficulty": "medium",
    "category": "React & Next.js"
  },
  {
    "_id": "6a454d73804dde39cc65cfbd",
    "question": "What is a Polyfill? How do you write a custom polyfill for the JavaScript `Array.prototype.map` function?",
    "answer": "A **polyfill** is a piece of code (typically JavaScript on the web) used to provide modern functionality on older browsers that do not natively support it.\n\nWriting custom polyfills is a common interview technique to test your core understanding of JavaScript prototypes, contextual binding (`this`), and array iteration.\n\n### Designing the Polyfill for `.map()`\nThe standard `.map(callback, thisArg)` method:\n1. Takes a callback function and an optional context argument (`thisArg`).\n2. Iterates over the original array.\n3. Executes the callback on each element, passing: `element`, `index`, and `originalArray`.\n4. Returns a *new* array containing the results of the callback.\n\n```javascript\n// Check if the method already exists to avoid overriding it\nif (!Array.prototype.myMap) {\n  Array.prototype.myMap = function(callback, thisArg) {\n    // 'this' refers to the array on which myMap was called\n    if (this == null) {\n      throw new TypeError('Array.prototype.myMap called on null or undefined');\n    }\n    if (typeof callback !== 'function') {\n      throw new TypeError(callback + ' is not a function');\n    }\n\n    const result = [];\n    const array = Object(this);\n    const length = array.length >>> 0; // Convert to unsigned 32-bit integer\n\n    for (let i = 0; i < length; i++) {\n      if (i in array) {\n        // Execute callback with bound context if provided\n        const mappedValue = callback.call(thisArg, array[i], i, array);\n        result.push(mappedValue); \n      }\n    }\n\n    return result;\n  };\n}\n\n// Usage Demonstration:\nconst numbers = [1, 2, 3];\nconst doubled = numbers.myMap(x => x * 2);\nconsole.log(doubled); // -> [2, 4, 6]\n```",
    "difficulty": "hard",
    "category": "JavaScript Advanced"
  },
  {
    "_id": "6a454d73804dde39cc65cfbe",
    "question": "What is Zustand and how does it compare to Redux Toolkit for state management in React?",
    "answer": "**Zustand** is a lightweight, fast, and simple state management library based on simplified flux principles. It is often preferred over Redux Toolkit for small-to-medium apps due to its zero-boilerplate setup.\n\n### 1. Zustand\n- **Boilerplate**: Extremely low. You define a store hook in a single function call.\n- **Usage**: No `<Provider>` wrapper required at the root level of your app. You just import the custom hook and use it directly.\n- **Rendering**: Only re-renders components that select specific slices of state.\n- **Simplicity**: No complex reducers, action types, or slice configurations.\n\n### 2. Redux Toolkit (RTK)\n- **Boilerplate**: Moderate-to-high. Requires creating slices, configureStore, and wrapping the app in a `<Provider>`.\n- **Developer Tooling**: Unmatched. Supports Redux DevTools (time-travel debugging), middlewares, and standard integration structures.\n- **Scalability**: Excellent for enterprise apps with complex state dependencies and side-effects.\n\n```javascript\n// Zustand Store Example\nimport { create } from 'zustand';\n\nconst useCounterStore = create((set) => ({ \n  count: 0,\n  increment: () => set((state) => ({ count: state.count + 1 })),\n  reset: () => set({ count: 0 })\n}));\n\n// React Component Usage:\nfunction Counter() {\n  const { count, increment } = useCounterStore();\n  return <button onClick={increment}>Count: {count}</button>;\n}\n```",
    "difficulty": "medium",
    "category": "React Architecture"
  },
  {
    "_id": "6a454d73804dde39cc65cfbf",
    "question": "What is the Critical Rendering Path (CRP) in browsers, and how do you optimize it for high performance?",
    "answer": "The **Critical Rendering Path** refers to the sequence of steps the browser takes to convert HTML, CSS, and JavaScript code into visible pixels on the screen.\n\n### The Steps of CRP:\n1. **DOM (Document Object Model)**: The browser parses HTML and constructs the DOM tree.\n2. **CSSOM (CSS Object Model)**: The browser parses CSS stylesheet rules and builds the CSSOM tree.\n3. **Render Tree**: Combines DOM and CSSOM to create a layout tree containing only the elements that are visible on the screen (elements with `display: none` are excluded).\n4. **Layout (Reflow)**: Calculates the exact geometry (width, height, position) of each element relative to the viewport.\n5. **Paint**: Fills in the actual colors, text fonts, borders, and shadows into drawing layers.\n6. **Composite**: Combines the layers in correct order (Z-index) to draw the final page.\n\n### How to Optimize CRP:\n- **Reduce Resource Sizes**: Minify, compress (Gzip/Brotli), and optimize images.\n- **Eliminate Render-Blocking CSS**: Inline critical styles, defer non-critical CSS.\n- **Eliminate Parser-Blocking JavaScript**: Use `async` or `defer` attributes on script tags to prevent HTML parsing interruptions.\n- **Pre-connect / Pre-load**: Use `<link rel=\"preload\">` to fetch key resources (fonts, critical scripts) early.",
    "difficulty": "hard",
    "category": "JavaScript Advanced"
  }
];
